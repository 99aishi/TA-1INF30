...
-- ESTÁNDAR: v2.0 (snake_case, minúsculas, singular, módulos rrhh, tes, ope)
-- MOTOR: MySQL 8.0+ / 5.7+ Compatibilidad extendida
-- NOTA: Las fechas de auditoría se gestionan mediante Triggers (NOW())
-- ===============================================================================
